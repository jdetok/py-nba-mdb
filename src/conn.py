...
class DBConn:
    def __init__(self):
        load_dotenv()
        self.host = environ['DB_IP'] 
        self.port = int(environ['DB_PORT'])
        self.database = environ['DB']
        self.user = environ['DB_USER']
        self.passw = environ['DB_PASS']
        self.logpath = None
    ...
    def insert(self, table, fields, values):
        ...
        if self.connection:
            try:
                ...
                self.ins_error.append(e)
                return self.ins_error
